...
import (
	...
	custom_profiles "github.com/yandex/perforator/perforator/pkg/storage/custom_profile/compound"
...
type Config struct {
	...
	CustomProfileStorage            *custom_profiles.Config                                         `yaml:"custom_profile"`
